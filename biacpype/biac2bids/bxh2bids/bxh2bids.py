...
import logging, time
from .bxh_pick_fields import bxh_pick
import string
import gzip
...
def create_bold_json(bxh_file, full_output):
    ...
    out_dict = bxh_pick(func_field_file, bxh_as_dict=bxh_contents)
...
def create_anat_json(bxh_file, full_output):
    ...
    out_dict = bxh_pick(anat_field_file, bxh_as_dict=bxh_contents)
...
def create_ncanda_json(bxh_file, full_output):
    ...
    out_dict = bxh_pick(fmap_field_file, bxh_as_dict=bxh_contents)
